...
<body>
 ...
 <div class="w3-content" style="max-width:1100px;margin-top:80px;margin-bottom:80px">
  <h1>웅진 Rental Soultion </h1>
  <h3>웅진 인턴 이동준</h3> 
	<p>현재 모바일사이즈로 변경중입니다. </p>
	<p>웹으로보면 깨집니다, iphone6기준!!!!!!!!!!!!</p>	
  <p>각종 api를 이용합니다. 현재는 회사 보안관련 문제로 깃허브 호스팅 url로 서비스 루트를 잡아놓았습니다. </p> 
 ...
 <div class="container">
  ...
  <form id = "login_form" method = "post" action="/home/insert.do" >    
    ...
    <br/> 
	  ...
	  <input type = "submit" value="로그인(아직안됨!!!)"  class="loginbtn"/>
      <input type = "button" value="취소" onclick="javascript:goList()" class="btn btn-info"/>
	  
   
  </form>
    <a href="" class="loginbtn">회원가입(임시)</a>
   </div>
  </div>  
 </div>    
